...
const prebuiltPlatforms = ["darwin-arm64", "darwin-x64", "linux-arm64", "linux-x64", "linux-sse2-x64", "win32-x64"];
...
const buildPlatformArch = () => {
  ...
  // Note: this `npm_config_arch` can be set to "sse2-x64" to force SSE2 on linux
